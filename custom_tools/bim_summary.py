...
def _build_level_batch_code(batch_cats, cat_map):
    ...
    lines.append("                type_name = _p.AsString() if (_p and _p.HasValue) else 'Unknown'")
    # Level detection
    ...
    lines.append("                    if level_el:")
    lines.append("                        try: level_name = level_el.Name")
    lines.append("                        except Exception: level_name = ''")
    ...
    lines.append("                        if lvl:")
    lines.append("                            try: level_name = lvl.Name")
    lines.append("                            except Exception: level_name = ''")
